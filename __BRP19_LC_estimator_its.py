...
if 1 == 1:
    ...
    erdfBir.to_csv('rmseBi19y.csv')
    erdfBi.to_csv('erdfBi19y.csv')
    crdf.to_csv('crdf19y.csv')
    rawdf.to_csv('rawdata19y.csv')
##    #erdf.dropna(axis=1)
    dcidf.to_csv('noData19y.csv')
##    
...
real_pred_df.explode(['RealX','PredX']).to_csv('real_pred_df19_brp.csv')
