...
if 1 == 1:
    ...
    erdfBir.to_csv('rmseBi16d.csv')
    erdfBi.to_csv('erdfBi16d.csv')
    crdf.to_csv('crdf16d.csv')
    rawdf.to_csv('rawdata16d.csv')
##    #erdf.dropna(axis=1)
    dcidf.to_csv('noData16d.csv')
##    
...
real_pred_df.explode(['RealX','PredX']).to_csv('real_pred_df16_mrp.csv')
