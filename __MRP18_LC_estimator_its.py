...
if 1 == 1:
    ...
    erdfBir.to_csv('rmseBi18d.csv')
    erdfBi.to_csv('erdfBi18d.csv')
##    crdf.to_csv('crdf18d.csv')
    rawdf.to_csv('rawdata18d.csv')
##    #erdf.dropna(axis=1)
    dcidf.to_csv('noData18d.csv')
##    
...
real_pred_df.explode(['RealX','PredX']).to_csv('real_pred_df18_mrp.csv')
