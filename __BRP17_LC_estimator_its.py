...
if 1 == 1:
    ...
    erdfBir.to_csv('rmseBi17y.csv')
    erdfBi.to_csv('erdfBi17y.csv')
    crdf.to_csv('crdf17y.csv')
    rawdf.to_csv('rawdata17y.csv')
##    #erdf.dropna(axis=1)
    dcidf.to_csv('noData17y.csv')
##    
...
real_pred_df.explode(['RealX','PredX']).to_csv('real_pred_df17_brp.csv')
