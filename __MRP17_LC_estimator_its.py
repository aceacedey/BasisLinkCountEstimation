...
date_index = pd.date_range('1/1/2017', periods=365, freq='D')
#AU_holidays = holidays.Australia()
...
mypath17 = r"LC data\2017 Link data"
numLinks = len(indf)
i = 0
dataframes = ''
...
if 1 == 1:
    ...
    erdfBir.to_csv('rmseBi17d.csv')
    erdfBi.to_csv('erdfBi17d.csv')
##    crdf.to_csv('crdf18d.csv')
    rawdf.to_csv('rawdata17d.csv')
##    #erdf.dropna(axis=1)
    dcidf.to_csv('noData17d.csv')
##    
...
real_pred_df.explode(['RealX','PredX']).to_csv('real_pred_df17_mrp.csv')
